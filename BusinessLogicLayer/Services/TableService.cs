...
namespace BusinessLogicLayer.Services
{
    public class TableService : ITableService
    {
        ...
        public async Task<int?> AddNewTableAsync(CreateTableDTO table)
        {
            ...
            if (!id.HasValue)
                throw new BusinessException("Failed to create table.", 80002, Enums.ActionResult.DBError);
        ...
        public async Task<ReadTableDTO?> GetTableByIDAsync(int id)
        {
            ...
            if (entity == null)
                throw new BusinessException("Table not found.", 80001, Enums.ActionResult.NotFound);
        ...
        public async Task<bool> UpdateTableAsync(int ID, UpdateTableDTO table)
        {
            ...
            if (!updated)
                throw new BusinessException("Failed to update table.", 80002, Enums.ActionResult.DBError);
        ...
        public async Task<bool> DeleteTableByIDAsync(int id)
        {
            ...
            if (!deleted)
                throw new BusinessException("Failed to delete table.", 80002, Enums.ActionResult.DBError);
